...
class App {
    ...
    #setupLight() {
        ...
        const light2 = new THREE.AmbientLight(0xff0000, 0.2);
        ...
        // shadowCamera.top = shadowCamera.right = 6;
        // shadowCamera.bottom = shadowCamera.left = -6;
        // const shadow = light.shadow;
        // shadow.mapSize.width = shadow.mapSize.height = 1024 * 2;
        // //해상도 너무 선명해도 문제
        // console.log(shadow.radius);
        // shadow.radius = 10;
        // // 그림자 가장자리 부드럽게
        ...
        const light = new THREE.SpotLight(0xfffffff, 2);
        light.castShadow = true;
        ...
        // const light = new THREE.RectAreaLight(0xffffff, 4, 5, 2);
    ...
    #setupModel() {
        ...
        bigSphere.position.set(0, 1.6, 0);
